...
const Welcome = () => {
  ...
  useEffect(() => {
    console.log("[Welcome.jsx] useEffect - Page Loaded");
    setWelcomeScreens(document.querySelectorAll(".welcome-screen-jg"));
    setIsLoaded(true);
    if (progressBarRef.current) {
      const newWidth = `${(currentScreen / 8) * 100}%`;
      progressBarRef.current.style.minWidth = newWidth;
      console.log("[Welcome.jsx] progressBarRef min-width:", progressBarRef.current.style.minWidth, "width:", progressBarRef.current.style.width);
    }
  }, []);

  useEffect(() => {
    console.log("[Welcome.jsx] useEffect - Progress Bar");
    console.log("[Welcome.jsx] progressBarRef:", progressBarRef);
    console.log("[Welcome.jsx] currentScreen:", currentScreen);
    if (isLoaded && progressBarRef.current) {
      const newWidth = `${(currentScreen / 8) * 100}%`;
      progressBarRef.current.style.minWidth = newWidth;
      console.log("[Welcome.jsx] progressBarRef min-width:", progressBarRef.current.style.minWidth, "width:", progressBarRef.current.style.width);
    }
  ...
  const nextScreen = () => {
    console.log("[Welcome.jsx] nextScreen - currentScreen:", currentScreen);
    console.log("[Welcome.jsx] nextScreen - welcomeScreens:", welcomeScreens);
    if (currentScreen === 8) {
      window.location.href = "/";
    } else {
      setWelcomeScreens((prevScreens) => {
        prevScreens[currentScreen - 1].classList.add("hidden-jg");
        prevScreens[currentScreen].classList.remove("hidden-jg");
        return prevScreens;
      });
  ...
  const prevScreen = () => {
    console.log("[Welcome.jsx] prevScreen - currentScreen:", currentScreen);
    console.log("[Welcome.jsx] prevScreen - welcomeScreens:", welcomeScreens);
    setWelcomeScreens((prevScreens) => {
      prevScreens[currentScreen - 1].classList.add("hidden-jg");
      prevScreens[currentScreen - 2].classList.remove("hidden-jg");
      return prevScreens;
    });
    if (currentScreen > 1) {
      setCurrentScreen((prevScreen) => prevScreen - 1);
  ...
  return (
    <main className="main-jg">
      ...
      <div className="welcome-jg">
        <div key="1" className="welcome-screen-jg screen-1-jg">
          <div className="welcome-text-jg">
            ...
            <p>
              ...
              click on the arrow at the bottom right of the screen to move on to
              the next one.
            </p>
            <p>
        ...
        <div key="2" className="welcome-screen-jg screen-2-jg hidden-jg">
          <div className="welcome-text-container-jg">
            <div className="welcome-text-jg">
              <h1>Profile Photo</h1>
              <p>
                If you have a profile photo you'd like to use, you can upload it
                here.
              </p>
              <p>
        ...
        <div key="3" className="welcome-screen-jg screen-3-jg hidden-jg">
          <div className="welcome-text-jg">
            ...
            <p>
              The average person sleeps 8 hours a day, works 8 hours a day, and
              has 8 hours of personal time, so we've set that as the default.
              We'll be dealing with sleep time later.
            </p>
            <p>
              Move the slider to the left or right to adjust your desired
              work/life balance goal.
            </p>
            <div className="welcome-work-life-slider-jg">SLIDER GOES HERE</div>
          </div>
        </div>
        <div key="4" className="welcome-screen-jg screen-4-jg hidden-jg">
          <div className="welcome-text-container-jg">
            <div className="welcome-text-jg">
        ...
        <div key="5" className="welcome-screen-jg screen-5-jg hidden-jg">
          <div className="welcome-text-jg">
        ...
        <div key="6" className="welcome-screen-jg screen-6-jg hidden-jg">
          <div className="welcome-text-jg">
        ...
        <div key="7" className="welcome-screen-jg screen-7-jg hidden-jg">
          <div className="welcome-text-jg">
            <h1>Color Scheme</h1>
            <p>
        ...
        <div key="8" className="welcome-screen-jg screen-8-jg hidden-jg">
          <div className="welcome-text-jg">
            <h1>We're all set.</h1>
            <p>
        ...
        <div className="navigation-arrow-container-jg">
          <a
            ...
            className={
              currentScreen === 1
                ? "navigation-arrow-button-jg disabled-jg"
