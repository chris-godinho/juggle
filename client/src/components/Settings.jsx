...
export default function Settings() {
  ...
  const [displayAddSubtypeFormError, setDisplayAddSubtypeFormError] =
    useState(false);
  const [displayRemoveSubtypeFormError, setDisplayRemoveSubtypeFormError] =
    useState(false);
  ...
  const handleRemoveSubtypeFormSubmit = async (event) => {
    ...
    console.log("[Settings.jsx] handleRemoveSubtypeFormSubmit - removeSubtypes");
              ...
              /* Localization Settings */ <div className="settings-localization-container">
                ...
                >
                  ...
                  <select
                    ...
                    value={
                      formData?.user?.localizationSettings?.timeZone || "0"
                    }
                    onChange={handleInputChange}
                  >
