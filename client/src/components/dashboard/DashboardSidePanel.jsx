...
export default function DashboardSidePanel({ eventType }) {
  ...
  const { events, eventsLoading, userLoading, eventsRefetch } =
    useDataContext();
  ...
  return (
    ...
    >
      {!showStats && eventType === "Work" && (
        <>
          <div className="side-panel-brand-jg">
            <svg
              className="juggler-logo-jg side-panel-logo-jg"
        ...
        <>
          {showStats && (
            <SidePanelStats
              ...
              workPercentageWithSleepingHours={workPercentageWithSleepingHours}
              lifePercentageWithSleepingHours={lifePercentageWithSleepingHours}
          ...
          {(showStats || (!showStats && eventType === "Life")) && (
            <SidePanelEvents
              ...
              totalAlottedTimeIgnoreUnalotted={totalAlottedTimeIgnoreUnalotted}
              showStats={showStats}
            />
          )}
